...
// Estender a interface Mouse do Matter.js para incluir as propriedades que precisamos
...
const Gravity = forwardRef<GravityRef, GravityProps>(
  (
    ...
    const initializeRenderer = useCallback(() => {
      ...
      const mouse = Mouse.create(render.current.canvas) as ExtendedMouse
      
      // Remover os event listeners do mouse para permitir scroll
      ...
      // Adicionar handler para wheel event com tipagem correta
      if (canvas.current) {
        canvas.current.addEventListener('wheel', (event: WheelEvent) => {
